...
struct LoginView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Ambient glow effect
            Circle()
                .fill(Color(red: 0.8, green: 0.1, blue: 0.1).opacity(0.15))
                .blur(radius: 100)
                .offset(y: -200)
                ...
                VStack(spacing: 16) {
                    ...
                    ZStack {
                        ...
                        Image(systemName: "flame.fill")
                            ...
                            .foregroundStyle(
                                LinearGradient(
                                    colors: [.white, AppTheme.accent], startPoint: .top,
                                    endPoint: .bottom))
                    }
                ...
                VStack(spacing: 20) {
                    Button(action: {
                        ...
                        HStack(spacing: 12) {
                            ...
                            Text(
                                authViewModel.isLoading ? "Connecting..." : "Connect Phantom Wallet"
                            )
                            .fontWeight(.semibold)
                        }
                    }
                ...
                VStack {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 12, style: .continuous)
                            .fill(Color.clear)
                            .glassEffect(
                                .regular.tint(AppTheme.accentSecondary).interactive(),
        ...
        .alert("Error", isPresented: $authViewModel.showError) {
            ...
            if authViewModel.errorMessage?.contains("not installed") == true {
                Button("Get Phantom") {
                    if let url = URL(
                        string: "https://apps.apple.com/app/phantom-crypto-wallet/id1598432977")
                    {
